...
let cc = Config.sessionName.replace(/MINZZA-MD;;;/g, "").replace(/BLACK;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
...
app.listen(port, () => console.log(`Minzza Server listening on port http://localhost:${port}!`));
